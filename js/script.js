...
const steps = {
    1: {
        title: 'お電話確認',
        message: '「ABC社コールセンターの○○でございます。〇〇様でお間違いないでしょうか？」',
        options: ['はい', 'いいえ'],
        next: {
            'はい': 2,
            'いいえ': 99
    ...
    3: {
        title: 'お時間の確認',
        message: 'いつもABC社サービスをご利用いただきありがとうございます。\nただいま、ABC社ご利用中のお客様向けに特別なご案内を差し上げております。\n今、お時間はよろしいでしょうか？',
        options: ['はい', 'いいえ'],
        next: {
            'はい': 4,
            'いいえ': 98
    ...
    4: {
        ...
        options: ['docomo', 'au', 'SoftBank', '楽天モバイル', 'Y!mobile', 'UQモバイル', 'mineo', 'IIJmio', 'ahamo', 'povo', 'LINEMO', 'ABCモバイル', 'その他', '不明'],
        next: {
            '*': 5
        }
    },
    ...
    11: {
        title: '端末チェック',
        message: 'ありがとうございます。端末チェッカーで確認しますので、少々お待ちください.\n\n[端末チェッカーを開く](https://abc-company.example/device-checker)',
        options: ['切替可能', '切替不可'],
        next: {
            '切替可能': 12,
            '切替不可': 13
    ...
    15: {
        title: '料金プランの案内',
        message: 'ここからは簡単にABCモバイルの料金プランをご案内させていただきます。\nいつもABC社をご利用いただき誠にありがとうございます。\n本日は、ABC社をお使いの皆様へ、特別に携帯電話料金プランをご案内させていただきます。\n\n現在のプロモーションでは、**通常料金のままでデータ容量が増量される**内容です。\n\n例えば、1GBプランの場合、月額980円のままで**5GB**までお使いいただけます。\n（※お客様の現在のデータ容量に応じて、適切な価格帯の例を提示）',
        options: ['興味がある', '興味がない'],
        next: {
            '興味がある': 16,
            '興味がない': 99
    ...
    21: {
        title: 'トスアップ',
        message: '情報共有にお時間を頂き、有難うございました。ここからはABC社の専任スタッフにおつなぎいたします。  お申し込みやご質問の対応をさせていただきますのでご安心ください。\n\n※東京センターへ電話を転送してトスアップ：電話番号：03-1234-5678\n無事に転送できたら、ABC社のスタッフに引き継ぎ。',
        options: ['対応終了'],
        next: {
            '対応終了': 99,
            '*': 99
    ...
    98: {
        title: '再架電のアポとり',
        message: 'お忙しい中大変失礼いたしました。改めてご案内させていただきますので、ご都合のよろしい日時を教えていただけますか？※土日は言語によって対応不可。ABC社の窓口は18時で終了することに注意。',
        options: ['対応終了'],
        next: {
            '対応終了': 99,
            '*': 99
    ...
    99: {
        title: '対応終了',
        message: '本日はお時間をいただき誠に有難うございました。何かご不明な点がございましたら、お気軽にご連絡ください。今後ともABC社をよろしくお願い申し上げます。',
        options: [],
        next: {}
    }
};
...
function showFAQ() {
    ...
    if (faqContainer) {
        faqContainer.innerHTML = `
            <div class="faq-item">
                <h3>✅ 30GB以上の大容量で利用していてABC社だとプランがない、、、</h3>
                <p>実際にはそこまで利用（消化）していない場合もあるため、現キャリアのマイページで確認してもらい実態を認識してもらう</p>
                <p>ABC光ネットとの併用をすることで抜えることも可能と伝え</p>
            </div>
